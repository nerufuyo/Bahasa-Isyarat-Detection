...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\Orbit\Studi Independen\Project Akhir\sign-language'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\Orbit\Studi Independen\Project Akhir\sign-language\Scripts\deactivate.nu'
